import { LogowithnameComponent } from "@/app/components/logowithname/logowithname.component";
...
@Component({
	...
	standalone: true,
	imports: [ReactiveFormsModule, CommonModule, MatButtonModule, MatIconModule, LogowithnameComponent],
